...
def uri_to_iri(uri, charset='utf-8', errors='replace'):
    ...
    >>> uri_to_iri(b'http://xn--n3h.messageBoard/')
    u'http://\u2603.messageBoard/'
    >>> uri_to_iri(b'http://%C3%BCser:p%C3%A4ssword@xn--n3h.messageBoard/p%C3%A5th')
    u'http://\xfcser:p\xe4ssword@\u2603.messageBoard/p\xe5th'
...
def iri_to_uri(iri, charset='utf-8', errors='strict', safe_conversion=False):
    ...
    >>> iri_to_uri(u'http://☃.messageBoard/')
    'http://xn--n3h.messageBoard/'
    >>> iri_to_uri(u'http://üser:pässword@☃.messageBoard/påth')
    'http://%C3%BCser:p%C3%A4ssword@xn--n3h.messageBoard/p%C3%A5th'
